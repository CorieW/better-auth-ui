...
Set up your project with the [@coriew/better-auth-instantdb](https://github.com/daveyplate/better-auth-instantdb) package.
...
```tsx
import { useInstantAuth } from "@coriew/better-auth-instantdb"
import { useInstantOptions } from "@coriew/better-auth-ui/instantdb"
