...
Set up your project with the [@coriew/better-auth-triplit](https://github.com/daveyplate/better-auth-triplit) package.
...
```tsx
import { useTriplitHooks } from "@coriew/better-auth-ui/triplit"
